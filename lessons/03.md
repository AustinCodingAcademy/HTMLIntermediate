...
Create a new folder called *syntax* and files called *index.html* and *syntax.js* and set up new *package.json* and *gulpfile.js*.
...
> Create five examples each of statements and expressions.
...
> Create some statements with and without semicolons, what happens?
...
> Add comments to the code we've already written.
...
> Create variables for your name, your age, your favorite color, and a boolean that answers the question, *Did you eat a hamburger today?*.
...
4) Take the list of NATO phonetic alphabet words from the last lesson. Each of those 26 words will now be the name for a string which is equal to the letter is it associated with, for example, the variable `alpha` will equal 'a';
