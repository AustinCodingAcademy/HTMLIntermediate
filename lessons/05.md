...
> 2. Add to it your three favorite foods.
> 3. Log the array to your console.
> 3. Log the size of the array to your console.
> 3. Before the first element, add 'Tamales'.
> 4. After the last element, add 'Calzones'.
> 5. Anywhere in the middle, add 'Tres Leches'.
> 3. Log the array to your console.
> 6. Remove all your original favorites, log your new list of favorites to the console.
