...
In this lesson, we will learn about several types of operators, control flow, and how ot use them together.
...
> Explain what happened in that last example.
> 
> Comment your code describing what happened.
> 
> Write an `if..elseif` statement describing the things you might do each day of the week.
...
> Given `let rando = Math.random();`, write a ternary expression that assigns a variable the string 'Yes' when rando < 0.5 and 'No' otherwise.
> 
> Can you think of any times where we would want a ternary operator instead of an `if..else` statement?

---

## Switch Statements

I think the best way to illustrate why 
