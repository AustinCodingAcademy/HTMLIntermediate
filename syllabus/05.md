...
This bit of code says, "For each item in the array, log its value to the console".

What if we abstracted this into a function.
...
This second example is only a tiny bit shorter, but a bit easier to read.
